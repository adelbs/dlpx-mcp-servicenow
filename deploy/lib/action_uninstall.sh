...
action_uninstall() {
    ...
    log_warn "System packages (nginx, certbot, firewalld, uv, ollama, etc.), any pulled Ollama"
    log_warn "models, and the issued TLS certificate under /etc/letsencrypt are NOT removed."
